...
import { Users, CheckCircle2, MessageCircle, Sparkles } from 'lucide-react';
...
export default function CarList({ onSelectCar, lang }: CarListProps) {
  ...
  const handleWhatsAppBooking = (carName: string) => {
    ...
    const message = `Halo Cici Rentcar Ende, saya berminat memesan unit ${carName} untuk perjalanan di Flores (081236024604). Mohon info ketersediaan & tarifnya. Terima kasih!`;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3" id="cars-heading">
          ...
          <p className="font-sans text-slate-600 text-sm sm:text-base leading-relaxed font-medium">
            Seluruh kendaraan selalu dalam kondisi prima, terawat, AC dingin, dan kabin bersih. Sudah termasuk Driver ramah & berpengalaman di rute Flores.
          </p>
        </div>
          ...
          {CARS.map((car, index) => (
            ...
            >
              <div className="space-y-5 text-left">
                ...
                {/* Image Showcase with Category Badge & Price Tag Overlay */}
