...
import { Calendar, Users, Settings, MapPin } from 'lucide-react';
...
export default function CarList({ onSelectCar, lang }: CarListProps) {
  ...
  const handleWhatsAppDirect = (carName: string) => {
    ...
    const message = `Halo Cici Rentcar Ende, saya tertarik untuk memesan unit ${carName}. Mohon informasi ketersediaan tanggal dan tarifnya (081236024604).`;
            ...
            >
              ...
              <div className="relative overflow-hidden aspect-[4/3] bg-gray-100">
                ...
                <div className="absolute top-4 right-0 bg-[#2563eb] text-white px-4 py-1.5 rounded-l-full rounded-r-none font-display font-bold text-xs shadow-md">
                  {car.pricePerDay > 0 ? `Mulai Rp ${car.pricePerDay.toLocaleString('id-ID')} / hari` : 'Hubungi Kontak'}
                </div>
              ...
              <div className="p-6 flex flex-col flex-grow space-y-4 text-left">
                ...
                <div className="pt-4 mt-auto border-t border-gray-100 flex items-center gap-3">
                  ...
                  >
                    ...
                    <span>{lang === 'EN' ? 'Reserve Now' : 'Pesan Sekarang'}</span>
                  </button>
